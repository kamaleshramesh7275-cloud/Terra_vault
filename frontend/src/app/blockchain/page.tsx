...
import {
  ...
  RefreshCw, Key, Layers, Copy, Check, CheckCircle
} from "lucide-react";
  ...
  const handleGenerateZKProof = () => {
    ...
    setTimeout(() => {
      ...
      setProofResult({
        ...
        gas_used: "142,850 Gwei",
        contract_address: CONTRACT_ADDRESS,
        explorer_url: `https://amoy.polygonscan.com/address/${CONTRACT_ADDRESS}`,
      });
              ...
              <div style={{ display: "flex", gap: 10 }}>
                ...
                <a
                  ...
                  style={{
                    ...
                    background: "#f1f5f9", color: "#0f172a", border: "1.5px solid #cbd5e1",
